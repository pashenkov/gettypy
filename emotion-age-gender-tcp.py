...
def main():
    ...
    while True:
        ...
        # so when it is a tuple which means no people are detected
        numPep = 0 if type(faces) is tuple else len(faces)
        ...
        for (x, y, w, h) in faces:
            if w > 40:  # 130: #ignore small faces
                ...
                try:
                    ...
                    print("Age and gender distributions error", str(e))
                ...
                try:
                    ...
                    print("Age 1 and gender 1 detection error", str(e))
                ...
                try:
                    ...
                    print("Age 2 and gender 2 detection error", str(e))
                ...
                if (shouldUpdateEmotion):
                    ...
                    try:
                        ...
                        print("get title/description error", str(e))
                        title = random.choice(titles_list)
                        description = random.choice(descriptions_list)
